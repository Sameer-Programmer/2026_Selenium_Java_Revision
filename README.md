...
## Selenium Test Cases Overview (DaySelenium1)

Here's a summary of the Selenium test cases found in the `src/test/java/DaySelenium1` directory:
...
## Selenium Test Cases Overview (Sameer_Fun)

Here's a summary of the Selenium test cases found in the `src/test/java/Sameer_Fun` directory:
